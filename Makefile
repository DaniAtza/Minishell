...
<<<<<<< HEAD
	$(addprefix builtin/, is_exe_builtin.c ft_echo.c ft_pwd.c ft_export_unset.c) \
	$(addprefix execute/, cmd_search.c execution.c heredoc.c utils_exe.c pipes_and_redirects.c)
=======
